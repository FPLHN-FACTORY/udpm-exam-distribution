...
import fplhn.udpm.examdistribution.core.teacher.examshift.model.response.TBlockResponse;
...
@Repository
public interface TBlockExtendRepository extends BlockRepository {
    ...
    @Query(value = """
            ...
            WHERE
            	...
            	AND s.id = :subjectId
            """, nativeQuery = true)
    List<TBlockResponse> findAllByClassSubjectCodeAndSubjectId(String classSubjectCode, String subjectId);
