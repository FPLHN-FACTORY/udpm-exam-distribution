...
public class SubjectGroupRestController {
    ...
    @PostMapping
    public ResponseEntity<?> createRoleSubjectGroup(@RequestBody CreateSubjectGroupRequest request) {
        return Helper.createResponseEntity(manageRoleSubjectGroup.createRoleSubjectGroup(request));
    }

    @PutMapping("/{subjectGroupId}")
    public ResponseEntity<?> updateRoleSubjectGroup(
            @PathVariable String subjectGroupId,
            @RequestBody ModifySubjectGroupRequest request
    ) {
