...
import fplhn.udpm.examdistribution.core.headdepartment.joinroom.model.response.HDBlockResponse;
...
@Repository
public interface HDBlockExtendRepository extends BlockRepository {
    ...
    @Query(value = """
            ...
            WHERE
            	...
            	AND s.id = :subjectId
            """, nativeQuery = true)
    List<HDBlockResponse> findAllByClassSubjectCodeAndSubjectId(String classSubjectCode, String subjectId);
