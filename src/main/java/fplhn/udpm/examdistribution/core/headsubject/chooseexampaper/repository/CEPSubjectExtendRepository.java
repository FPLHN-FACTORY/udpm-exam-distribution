...
import fplhn.udpm.examdistribution.core.headsubject.chooseexampaper.model.response.CEPListSubjectResponse;
...
@Repository
public interface CEPSubjectExtendRepository extends SubjectRepository {
    ...
    @Query(value = """
            ...
            WHERE
                ...
                sg.status = 0
            """, nativeQuery = true)
    List<CEPListSubjectResponse> getListSubject(String userId, String departmentFacilityId, String semesterId);
