...
const fetchDetailResource = () => {
    showLoading();
    $.ajax({
        url: ApiConstant.API_HEAD_SUBJECT_CHOOSE_EXAM_PAPER + "/detail-resource/" + getStateValueResourceExamPaperId(),
        method: "GET",
...
const fetchListResource = (
    ...
    let url = ApiConstant.API_HEAD_SUBJECT_CHOOSE_EXAM_PAPER + "/resources" + '?';
...
$("#button-save-resource").on("click", () => {
    showLoading();
    $.ajax({
        url: ApiConstant.API_HEAD_SUBJECT_CHOOSE_EXAM_PAPER + "/resources",
